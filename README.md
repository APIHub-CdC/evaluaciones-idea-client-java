# evaluaciones-idea-java

Evaluaciones IDEA
- API version: 1.0.0
IDEA identifica las fortalezas y el talento de tu equipo comercial evaluando sus habilidades de venta para determinar su lugar ideal dentro de tu organización.
...
En el archivo **EvaluacionesIDEATest**, que se encuentra en ***src/test/java/io/apihub/client/api*** se deberá modificar el siguiente fragmento de código con los datos correspondientes en los objetos *Persona* y *Domicilio*:
...
@Test
public void EvaluacionesIDEATest() {
    ...
    Respuesta response;
    try {
        response = api.getEvaluacionesIDEA(cveUsuario, cveEmpresa, xApiKey, password, body);
